...
export function OrderFilterToolbar({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-white p-3 rounded-2xl border border-slate-200/90 shadow-2xs space-y-2.5 sm:space-y-0 sm:flex sm:items-center sm:justify-between sm:gap-3">
        {/* Search Bar */}
        <div className="relative w-full sm:flex-1 min-w-0">
          ...
          <input
            ...
            placeholder="Search by Order #, Customer, Mobile, City..."
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] text-slate-500 hover:text-slate-800 font-bold bg-slate-200/70 hover:bg-slate-200 rounded-full w-4 h-4 flex items-center justify-center transition-colors cursor-pointer"
            >
              ✕
            </button>
          )}
        ...
        {/* Filter Controls Row (Responsive Grid/Wrap) */}
        <div className="flex items-center gap-2 flex-wrap shrink-0 justify-between sm:justify-end">
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-xl border text-xs font-semibold transition-all shadow-2xs cursor-pointer ${
                activeStatusTab !== 'ALL'
